...
MODEL_REGISTRY: Dict[str, Any] = {
    "remote_vlm": {
        ...
        "adapter_repo": "CODEXSHAN/satquery-qwen2vl-bigearthnet",
        "training_script": "train_bigearthnet_lora.py",
        "training_dataset": "bigearthnet/bigearthnet-mm-vqa",
        "training_metadata": "bigearthnet_lora_qwen2vl/training_metadata.json",
    },
    "changechat": {
        "name": "ChangeChat",
